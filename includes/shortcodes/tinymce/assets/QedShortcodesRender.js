window._sdresizeIframe = function( obj ) {
    setTimeout(function() {
...
(function() {
    var $ = jQuery;
    tinymce.create( 'tinymce.plugins.QedShortcodesRender', {
        settingsDefault:{
            action:'swishdesign_render_shortcode',
            shortcodes:[]
        },
            ...
            View:{
                ...
                getHtml: function() {
                    ...
                    return '<div style="position:relative">' +
                        ...
                        '<iframe scrolling="no" height="0" frameborder="0" onload="top._sdresizeIframe( this );" width="100%" src="' + ajaxurl + '?' + $.param( data ) + '"></iframe>' +
                        '</div>';
                }
            },
    ...
    tinymce.PluginManager.add( 'QedShortcodesRender', tinymce.plugins.QedShortcodesRender );
})();
